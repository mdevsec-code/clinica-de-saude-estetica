...
const AUDIT_RULES: Record<string, AuditRule> = {
  ...
  'POST /patients': { entityType: 'patient', action: 'CREATE', label: (body) => str(body.name) },
  'PATCH /patients/:id': { entityType: 'patient', action: 'UPDATE', label: (body) => str(body.name) },
  'POST /patients/:id/photos': {
    entityType: 'patient_photo',
    action: 'CREATE',
    label: (body) => str(body.category as string | undefined),
  },
  'DELETE /patients/:id/photos/:photoId': { entityType: 'patient_photo', action: 'DELETE', label: () => undefined },
  'POST /patients/:id/notify-birthday': { entityType: 'whatsapp_notification', action: 'CREATE', label: () => 'aniversário' },
  'POST /patients/:id/fichas': { entityType: 'patient_ficha', action: 'CREATE', label: (body) => str(body.type as string | undefined) },
  'PATCH /patients/:id/fichas/:fichaId': { entityType: 'patient_ficha', action: 'UPDATE', label: (body) => str(body.type as string | undefined) },
  'DELETE /patients/:id/fichas/:fichaId': { entityType: 'patient_ficha', action: 'DELETE', label: () => undefined },
  'PATCH /reminders/:id/status': {
    entityType: 'return_reminder',
    action: 'UPDATE',
    label: (body) => str(body.status as string | undefined),
  },
  'POST /reminders/:id/notify-whatsapp': { entityType: 'whatsapp_notification', action: 'CREATE', label: () => 'retorno' },
